...
scatter_data_frame <- function(
  ...
  groups = NULL,
  facets = NULL,
  log = getOption('metaplot_log_scatter',FALSE),
  ylog = getOption('metaplot_ylog_scatter',log),
  xlog = getOption('metaplot_xlog_scatter',log),
  crit = getOption('metaplot_crit_scatter',1.3),
  yref = getOption('metaplot_yref_scatter',metaplot_ref),
  xref = getOption('metaplot_xref_scatter',metaplot_ref),
  ylab = getOption('metaplot_ylab_scatter',axislabel),
  xlab = getOption('metaplot_xlab_scatter',axislabel),
  ysmooth = getOption('metaplot_ysmooth_scatter',FALSE),
  xsmooth = getOption('metaplot_xsmooth_scatter',FALSE),
  iso = getOption('metaplot_iso_scatter',FALSE),
  na.rm = getOption('metaplot_narm_scatter',TRUE),
  aspect = getOption('metaplot_aspect_scatter',1),
  space = getOption('metaplot_space_scatter','right'),
  key = getOption('metaplot_key_scatter','metaplot_key'),
  as.table = getOption('metaplot_astable_scatter',TRUE),
  prepanel = getOption('metaplot_prepanel_scatter', NULL),
  scales = getOption('metaplot_scales_scatter',NULL),
  panel = getOption('metaplot_panel_scatter',scatter_panel),
  colors = getOption('metaplot_colors_scatter',NULL),
  symbols = getOption('metaplot_symbols_scatter',NULL),
  points = getOption('metaplot_points_scatter',TRUE),
  lines = getOption('metaplot_lines_scatter',FALSE),
  main = getOption('metaplot_main_scatter',NULL),
  sub = getOption('metaplot_sub_scatter',NULL),
  subscripts = getOption('metaplot_subscripts_scatter',TRUE),
  par.settings = getOption('metaplot_parsettings_scatter',NULL),
  padding = getOption('metaplot_padding_scatter', 1),
  ref.col = getOption('metaplot_ref_col_scatter','grey'),
  ref.lty = getOption('metaplot_ref_lty_scatter','solid'),
  ref.alpha = getOption('metaplot_ref_alpha_scatter',1),
  smooth.lty = getOption('metaplot_smooth_lty_scatter','dashed'),
  smooth.alpha = getOption('metaplot_smooth_alpha_scatter',1),
  fit = getOption('metaplot_fit_plot_scatter',conf),
  fit.lty = getOption('metaplot_fit_lty_scatter','solid'),
  fit.alpha = getOption('metaplot_fit_alpha_scatter',1),
  conf = getOption('metaplot_conf_plot_scatter',FALSE),
  conf.alpha = getOption('metaplot_conf_alpha_scatter',0.3),
  loc = getOption('metaplot_msg_loc_scatter',0),
  global = getOption('metaplot_global_aes_scatter',FALSE),
  global.col = getOption('metaplot_global_col_scatter','grey'),
  msg = getOption('metaplot_msg_format_scatter','metastats'),
  gg = getOption('metaplot_gg_scatter',FALSE),
  ...
){
...
scatter_panel <- function(
  ...
  y,
  groups,
  xref = getOption('metaplot_ref_x_scatter_panel',scatter_panel_ref),
  yref = getOption('metaplot_ref_y_scatter_panel',scatter_panel_ref),
  ref.col = getOption('metaplot_ref_col_scatter_panel','grey'),
  ref.lty = getOption('metaplot_ref_lty_scatter_panel','solid'),
  ref.alpha = getOption('metaplot_ref_alpha_scatter_panel',1),
  ysmooth = getOption('metaplot_smooth_y_scatter_panel',FALSE),
  xsmooth = getOption('metaplot_smooth_x_scatter_panel',FALSE),
  smooth.lty = getOption('metaplot_smooth_lty_scatter_panel','dashed'),
  smooth.alpha = getOption('metaplot_smooth_alpha_scatter_panel',1),
  fit = getOption('metaplot_fit_plot_scatter_panel',conf),
  fit.lty = getOption('metaplot_fit_lty_scatter_panel','solid'),
  fit.alpha = getOption('metaplot_fit_alpha_scatter_panel',1),
  conf = getOption('metaplot_conf_plot_scatter_panel',FALSE),
  conf.alpha = getOption('metaplot_conf_alpha_scatter_panel',0.3),
  loc = getOption('metaplot_msg_loc_scatter_panel',0),
  iso = getOption('metaplot_iso_scatter_panel',FALSE),
  global = getOption('metaplot_global_aes_scatter_panel',FALSE),
  global.col = getOption('metaplot_global_col_scatter_panel','grey'),
  msg = getOption('metaplot_msg_format_scatter_panel','metastats'),
  type,
  ...
)
{
