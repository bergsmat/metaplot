...
boxplot_data_frame <- function(
  ...
  xvar,
  facets = NULL,
  log = getOption('metaplot_log_boxplot',FALSE),
  crit = getOption('metaplot_crit_boxplot',1.3),
  horizontal = getOption('metaplot_horizontal_boxplot',NULL),
  scales = getOption('metaplot_scales_boxplot',NULL),
  panel = getOption('metaplot_panel_boxplot',boxplot_panel),
  ref = getOption('metaplot_ref_x_boxplot',metaplot_ref),
  ref.col = getOption('metaplot_ref_col_boxplot','grey'),
  ref.lty = getOption('metaplot_ref_lty_boxplot','solid'),
  ref.alpha = getOption('metaplot_ref_alpha_boxplot',1),
  nobs = getOption('metaplot_nobs_boxplot',FALSE),
  na.rm = getOption('metaplot_narm_boxplot',TRUE),
  xlab = NULL,
  ylab = NULL,
  numlab = getOption('metaplot_numlab_boxplot',axislabel),
  catlab = getOption('metaplot_catlab_boxplot',axislabel),
  aspect = getOption('metaplot_aspect_boxplot',1),
  main = getOption('metaplot_main_boxplot',NULL),
  sub = getOption('metaplot_sub_boxplot',NULL),
  par.settings = getOption('metaplot_parsettings_boxplot',standard.theme('pdf',color = FALSE)),
  padding = getOption('metaplot_padding_boxplot', 1),
  reverse = getOption('metaplot_reverse_boxplot',TRUE),
  pch = getOption('metaplot_pch_boxplot','|'),
  notch = getOption('metaplot_notch_boxplot',FALSE),
  gg = getOption('metaplot_gg_boxplot',FALSE),
  ...
){
