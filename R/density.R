...
densplot_data_frame<- function(
  ...
  groups = NULL,
  facets = NULL,
  xlab = getOption('metaplot_xlab_dens',axislabel),
  ref = getOption('metaplot_ref_x_dens',metaplot_ref),
  ref.col = getOption('metaplot_ref_col_dens','grey'),
  ref.lty = getOption('metaplot_ref_lty_dens','solid'),
  ref.alpha = getOption('metaplot_ref_alpha_dens',1),
  log = getOption('metaplot_log_dens',FALSE),
  crit = getOption('metaplot_crit_dens',1.3),
  aspect = getOption('metaplot_aspect_dens',1),
  scales = getOption('metaplot_scales_dens',NULL),
  panel = getOption('metaplot_panel_dens',dens_panel),
  colors = getOption('metaplot_colors_dens',NULL),
  symbols = getOption('metaplot_symbols_dens',NULL),
  points = getOption('metaplot_points_dens',TRUE),
  lines = getOption('metaplot_lines_dens',TRUE),
  fill = getOption('metaplot_fill_dens',FALSE),
  space = getOption('metaplot_space_dens','right'),
  key = getOption('metaplot_key_dens',metaplot_key),
  main = getOption('metaplot_main_dens',NULL),
  sub = getOption('metaplot_sub_dens',NULL),
  par.settings = getOption('metaplot_parsettings_dens',NULL),
  padding = getOption('metaplot_padding_dens', 1),
  gg = getOption('metaplot_gg_dens',FALSE),
  ...
){
