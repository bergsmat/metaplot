...
categorical_data_frame <- function(
  ...
  groups = NULL,
  facets = NULL,
  ylab = getOption('metaplot_xlab_categorical',axislabel),
  xlab = getOption('metaplot_ylab_categorical',axislabel),
  na.rm = getOption('metaplot_narm_categorical',TRUE),
  aspect = getOption('metaplot_aspect_categorical',1),
  space = getOption('metaplot_space_categorical','right'),
  key = getOption('metaplot_key_categorical','metaplot_key'),
  as.table = getOption('metaplot_astable_categorical',TRUE),
  prepanel = getOption('metaplot_prepanel_categorical', function(...)list(xlim=0:1,ylim=0:1)),
  scales = getOption('metaplot_scales_categorical',NULL),
  panel = getOption('metaplot_panel_categorical',categorical_panel),
  colors = getOption('metaplot_colors_categorical',NULL),
  fill = getOption('metaplot_fill_categorical',0.5),
  lines = getOption('metaplot_lines_categorical',TRUE),
  main = getOption('metaplot_main_categorical',NULL),
  sub = getOption('metaplot_sub_categorical',NULL),
  tex = getOption('metaplot_tex_categorical', 0.9),
  rot = getOption('metaplot_rot_categorical',c(90,0)),
  subscripts = getOption('metaplot_subscripts_categorical',TRUE),
  par.settings = getOption('metaplot_parsettings_categorical',NULL),
  padding = getOption('metaplot_padding_categorical', 1),
  loc = getOption('metaplot_msg_loc_categorical',5),
  msg = getOption('metaplot_msg_format_categorical','tilestats'),
  cex = getOption('metaplot_cex_categorical',1),
  gg = getOption('metaplot_gg_categorical',FALSE),
  ...
){
...
categorical_panel <- function(
  ...
  groups,
  bivariate = TRUE,
  loc = getOption('metaplot_msg_loc_categorical_panel',5),
  msg = getOption('metaplot_msg_format_categorical_panel','tilestats'),
  tex = getOption('metaplot_tex_categorical_panel', 0.9),
  cex = getOption('metaplot_cex_categorical_panel',1),
  rot = getOption('metaplot_rot_categorical_panel',c(90,0)),
  subscripts,
  ...
)
{
